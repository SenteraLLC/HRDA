...
# Default HRDA Configuration for Prospero->Weeds
_base_ = [
    '../_base_/default_runtime.py',
    # DAFormer Network Architecture
    '../_base_/models/daformer_sepaspp_mitb5.py',
    # Prospero->Weeds High-Resolution Data Loading
    '../_base_/datasets/uda_prosperoHR_to_weedsHR_1024x1024.py',
...
name = 'prosperoHR2weedsHR_hrda_s1'
exp = 'basic'
name_dataset = 'prosperoHR2weedsHR_1024x1024'
